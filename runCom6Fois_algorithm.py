...
class runCom6FoisAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        try:
            ...
            raise QgsProcessingException(
                self.tr("Something went wrong with com1DFA, please check log files")
            )
    ...
    def displayName(self):
        ...
        """
        return self.tr("Dense Flow Experimental (com6)")
    ...
    def shortHelpString(self) -> str:
        hstring = "Runs dense flow simulations via module com6Fois. \n\
